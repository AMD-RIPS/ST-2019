...
def test(X_test):
  ...
  t2 = time.time()
 # print('Transform Time for discoloration: ', t2-t1)

	# Load PCA / CLF models
  with open('discoloration_test/discolor-PCA-500.pkl', 'rb') as file:
    pca = pickle.load(file)
  with open('discoloration_test/discolor-LR-500.pkl', 'rb') as file:
  ...
  t2 = time.time()
 # print('Remaining Time for discoloration: ', t2-t1)
