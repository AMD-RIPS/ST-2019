...
image=np.array(cv2.imread(in_name,1))
...
if(np.array_equal(cv2.imread(in_name,1),image)):
    print("Error: no glitches produced.")
    print("ss: "+str(ss)+", stripes: "+str(stripes)+", orientation: "+str(orientation+", patch:"+str(width)+"x"+str(height)))
else:
